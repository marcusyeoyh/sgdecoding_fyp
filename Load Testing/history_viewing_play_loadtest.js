...
// export let options = {
//   stages: [
//     { duration: "5m", target: 10 }, // Slowly ramp up to 10 users over 5 minutes
//     { duration: "10m", target: 50 }, // Hold at 50 users for 10 minutes (peak)
//     { duration: "5m", target: 20 }, // Gradual decrease to 20 users
...
export let options = {
  stages: [
    ...
    { duration: "15m", target: 200 }, // Sustain 200 users
    { duration: "5m", target: 300 }, // Increase to 300 users
    { duration: "30m", target: 300 }, // Sustain 300 users
    { duration: "5m", target: 0 }, // Cool down
  ],
};
